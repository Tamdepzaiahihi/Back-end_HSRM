...
public class JwtManagerGroupAuthenticationFilter extends OncePerRequestFilter {
    public static final String JWT_KEY = "manager_jwt";

    private static final Logger LOGGER = LoggerFactory.getLogger(JwtManagerGroupAuthenticationFilter.class);
    ...
    private String extractTokenFromRequest(HttpServletRequest request) {
        ...
        return Arrays.stream(cookies).filter(cookie -> cookie.getName().equals("manager_jwt"))
